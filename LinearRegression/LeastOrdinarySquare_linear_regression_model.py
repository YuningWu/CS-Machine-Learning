...
class LinearRegression():
    ...
    def LeastOrdinarySquare(self,train_x,train_y):
        ...
        plt.savefig(r'D:/GoogleDirve/phd/5/class/HW/HW2/concrete/Batch.png')
        #plt.savefig(r'D:/GoogleDirve/phd/5/class/HW/HW2/concrete/stochastic.png')
        plt.show()
...
'''------main function------'''
train=pd.read_csv(r'D:/GoogleDirve/phd/5/class/HW/HW2/concrete/train.csv',header=None)
test=pd.read_csv(r'D:/GoogleDirve/phd/5/class/HW/HW2/concrete/test.csv',header=None)
...
'''
linear_model=LinearRegression(learning_rate=0.001,iteration_times=50000,GD_method='batch')
