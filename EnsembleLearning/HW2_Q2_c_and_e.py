...
def sample_variance(predict):
    ...
    File.to_csv(r'D:/GoogleDirve/phd/5/class/HW/HW2/bias_var.csv')
...
def var_bias(Train,Test,Numeric):
    ...
    for iter in range(100):
        print(iter)
        BT = BagTree(tree_no=100, sampling_rate=0.2)
        BT.train_model(Train, Test, Numeric)
        res = BT.predict(Test, Numeric)
        #RF = RandomForest(tree_no=10, feature_no=2, sampling_rate=0.01)
