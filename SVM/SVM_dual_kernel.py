...
#os.chdir('D:/GoogleDirve/phd/5/class/HW/HW4')
...
class SVM():
    ...
    def train_model(self, X, Y, C=100/ 873, epoch=100, learning_rate=0.0001,sigma=100):
...
def main():
    ...
    clf=SVM()
    clf.train_model(train_x,train_y,C=100/ 873, epoch=100, learning_rate=0.0001,sigma=100)
